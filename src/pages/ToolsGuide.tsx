...
const LABS_FEATURES = [
  ...
  { icon: 'fa-file-magnifying-glass', nameKo: '문서검색(RAG)', nameEn: 'Doc Search (RAG)', badge: '', descKo: '업로드한 문서를 근거로 정확한 답변. 방대한 규정집에서 근거 조항 찾기.', descEn: 'Answers grounded in your uploaded documents — find clauses in large rulebooks.' },
