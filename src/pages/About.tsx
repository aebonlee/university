...
export default function About(): ReactElement {
  return (
    <>
      <SEOHead title="About | University AI Education" description="전남대학교 직원·조교 대상 2일 과정(16교시) AI 실무 자동화 교육 플랫폼" />
      <section className="page-header">
        <div className="container">
          <h1>About</h1>
          <p>생성형 AI 기반 문서·인사행정 실무 자동화</p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <strong style={{ fontSize: '17px', display: 'block', marginBottom: '12px' }}>
              이 사이트는 전남대학교 직원·조교 대상 AI 실무 자동화 교육 플랫폼입니다.
            </strong>
            <p style={{ margin: 0 }}>
              드림아이티비즈(DreamIT Biz)는 기업과 개인의 실제 니즈를 반영한 맞춤형 교육 플랫폼을 제작합니다.
              2일 16교시 과정으로 생성형 AI를 활용한 문서·인사행정 실무 자동화를 학습합니다.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '48px' }}>
            {[
              { icon: 'fa-bullseye', title: '맞춤형 교육', desc: '대학 행정 업무에 최적화된 AI 활용 교육입니다.' },
              { icon: 'fa-file-word', title: '문서 자동화', desc: 'AI를 활용한 공문서, 보고서 작성 자동화를 실습합니다.' },
              { icon: 'fa-users-gear', title: '인사행정', desc: '인사·행정 업무의 AI 자동화 방법을 배웁니다.' },
              { icon: 'fa-laptop-code', title: '실습 중심', desc: '실제 업무 환경을 반영한 실습 위주 교육입니다.' },
            ].map((item, i) => (
              <div key={i} style={{
                display: 'flex',
                gap: '16px',
