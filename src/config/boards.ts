export const BOARDS = [
  {
    ...
    nameKo: '강의자료',
    nameEn: 'Lecture Materials',
    descKo: '교육 과정에서 사용되는 강의자료와 참고자료를 공유합니다.',
    descEn: 'Share lecture materials and reference documents used in the course.',
    color: '#1B5E20',
  },
  {
    id: 'qna',
    ...
    nameKo: 'Q&A',
    nameEn: 'Q&A',
    descKo: '교육 내용에 대한 질문과 답변을 나누는 공간입니다.',
    descEn: 'Ask questions and get answers about the course content.',
    color: '#1565C0',
  },
  {
    id: 'free',
    ...
    descEn: 'A space for free discussion.',
    color: '#6B7280',
  },
];
