...
export const CURRICULUM: SessionInfo[] = [
  ...
  { id: 5, day: 1, period: 5, title: 'PPT 구조 설계와 슬라이드 생성', titleEn: 'PPT Structure Design & Slide Generation', description: 'AI 기반 PPT 구조 설계, 슬라이드 초안 생성', tools: ['ChatGPT', 'Gamma', 'PowerPoint'], icon: 'fa-presentation-screen', source: 'copilot.dreamitbiz.com' },
  { id: 6, day: 1, period: 6, title: 'PPT 시각화와 디자인 완성', titleEn: 'PPT Visualization & Design', description: '시각자료 생성, 데이터 시각화, 디자인 완성', tools: ['Gamma', 'Canva', 'PowerPoint'], icon: 'fa-chart-pie', source: 'copilot.dreamitbiz.com' },
