...
export const CURRICULUM: SessionInfo[] = [
  ...
  { id: 5, day: 1, period: 5, title: 'PPT 구조 설계와 슬라이드 생성', titleEn: 'PPT Structure Design & Slide Generation', description: 'AI 기반 PPT 구조 설계, 슬라이드 초안 생성', tools: ['ChatGPT', 'Gamma', 'PowerPoint'], icon: 'fa-file-powerpoint', source: 'copilot.dreamitbiz.com' },
