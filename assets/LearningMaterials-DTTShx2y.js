import{j as e}from"./markdown-uD28ob7P.js";import{b as g,f as v,u as P,L as d}from"./vendor-j2q2Hh8J.js";import{u as A}from"./index-ydcigkKt.js";import{S as E}from"./SEOHead-CXt37xNM.js";import"./supabase-ClMXFR6t.js";function h({code:s,isKo:a=!0}){const[i,r]=g.useState(!1),n=async()=>{try{await navigator.clipboard.writeText(s)}catch{const t=document.createElement("textarea");t.value=s,t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t)}r(!0),setTimeout(()=>r(!1),2e3)};return e.jsxs("div",{className:"prompt-block",children:[e.jsxs("div",{className:"prompt-block-header",children:[e.jsxs("span",{className:"prompt-block-label",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"}),a?"프롬프트":"Prompt"]}),e.jsxs("button",{type:"button",className:`prompt-copy-btn ${i?"copied":""}`,onClick:n,children:[e.jsx("i",{className:`fa-solid ${i?"fa-check":"fa-copy"}`}),i?a?"복사됨":"Copied":a?"복사":"Copy"]})]}),e.jsx("pre",{className:"prompt-block-body",children:e.jsx("code",{children:s})})]})}const u={"meeting-reports":[{level:"basic",titleKo:"회의록 요약",titleEn:"Meeting Minutes Summary",promptKo:`[역할] 대학 행정 담당자
...
[Format] A ready-to-paste instruction (topic, structure, tone, color).`},{level:"advanced",titleKo:"브랜드 일관 디자인 세트",titleEn:"Consistent Brand Set",promptKo:"[심화 과제] 기관 브랜드 톤(색상·서체·여백 규칙)을 먼저 정의하고, 그 규칙에 맞춰 표지·간지·본문·마무리 슬라이드 디자인 가이드를 일관되게 생성하는 프롬프트를 설계하세요. 재사용 가능한 디자인 규칙을 산출하도록 지정하는 것이 핵심입니다.",promptEn:"[Advanced] First define a brand tone (color/type/spacing), then design a prompt that generates consistent cover/divider/body/closing slide guidelines to match. The key is producing reusable design rules."}],"excel-analysis":[{level:"basic",titleKo:"조건부 집계 수식 생성",titleEn:"Conditional Aggregation Formula",promptKo:`[역할] 대학 행정 담당자
