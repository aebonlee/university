import{j as e}from"./markdown-X-y-aifN.js";import{f as p,u as g,b as h,L as d}from"./vendor-j2q2Hh8J.js";import{u as f}from"./index-BFWWpX2t.js";import{S as A}from"./SEOHead-BQ9xiFHC.js";import"./supabase-ClMXFR6t.js";const y=[{id:"ai-basics",titleKo:"생성형 AI 기초",titleEn:"Generative AI Basics",descKo:"생성형 AI의 개념, 동작 원리, 주요 서비스 비교 및 대학 행정 활용 전략",descEn:"Generative AI concepts, principles, service comparison, and university administration strategies",sections:[{titleKo:"생성형 AI란?",titleEn:"What is Generative AI?",contentKo:`생성형 AI(Generative AI)는 텍스트, 이미지, 코드 등 새로운 콘텐츠를 생성할 수 있는 인공지능입니다.
...
[Length] {pages}
[Tone] {tone}
\`\`\``}]}],I=[{id:"document-automation",titleKo:"공문서·보고서 작성",titleEn:"Official Documents & Reports",descKo:"공문서, 회의록, 보고서를 AI로 빠르게 작성하고 검토하는 방법",descEn:"Quickly write and review official documents, meeting minutes, and reports with AI",sections:[{titleKo:"대학 행정 공문서 유형",titleEn:"University Administrative Document Types",contentKo:`| 유형 | 설명 | 예시 |
|------|------|------|
...
| Trip report | Chronological order | Timeline and insights |`}]},{id:"ppt-creation",titleKo:"PPT 보고자료 제작",titleEn:"PPT Report Creation",descKo:"AI 기반 PPT 구조 설계, Gamma·Canva 활용, 데이터 시각화 기법",descEn:"AI-based PPT structure design, Gamma/Canva usage, data visualization",sections:[{titleKo:"AI 기반 PPT 제작 도구",titleEn:"AI-Based PPT Tools",contentKo:`**Gamma (gamma.app)**
...
| Composition | Stacked bar | Compare compositions |`}]},{id:"excel-analysis",titleKo:"Excel 데이터 분석",titleEn:"Excel Data Analysis",descKo:"AI 활용 수식 생성, 데이터 정리, 피벗 테이블, VBA 매크로 기초",descEn:"AI-powered formula generation, data cleaning, pivot tables, VBA basics",sections:[{titleKo:"AI 활용 수식 생성",titleEn:"AI-Powered Formula Generation",contentKo:`AI에 Excel 작업을 설명하면 적합한 수식을 자동으로 생성해 줍니다.
...
\`\`\``}]}],v=[{id:"hr-administration",titleKo:"인사·근태 관리",titleEn:"HR & Attendance Management",descKo:"채용공고, 인사발령, 근태 관리, 근로계약서 등 인사 업무의 AI 활용",descEn:"AI usage for job postings, appointments, attendance, and employment contracts",sections:[{titleKo:"인사 업무 AI 활용 영역",titleEn:"AI Applications in HR",contentKo:`| 업무 영역 | AI 활용 방안 | 예상 효과 |
|-----------|-------------|-----------|
...
- Final version must be reviewed by legal team`}]},{id:"hr-report",titleKo:"인사 보고자료 제작",titleEn:"HR Report Presentation",descKo:"인사 현황 PPT 시각화, 데이터 기반 스토리텔링, 경영진 보고자료",descEn:"HR status PPT visualization, data-driven storytelling, executive reports",sections:[{titleKo:"인사 데이터 시각화 & 스토리텔링",titleEn:"HR Data Visualization & Storytelling",contentKo:`**인사 데이터 시각화 매핑**
...
- Positive results in green, caution in red`}]},{id:"work-automation",titleKo:"업무 자동화 설계",titleEn:"Work Automation Design",descKo:"프롬프트 라이브러리 구축, 워크플로우 설계, ROI 계산",descEn:"Prompt library building, workflow design, ROI calculation",sections:[{titleKo:"프롬프트 라이브러리 & 가이드라인",titleEn:"Prompt Library & Guidelines",contentKo:`**업무 템플릿 설계 원칙**
...
\`\`\``}]}],m=[{id:"basic",titleKo:"기본학습자료",titleEn:"Basic Materials",descKo:"생성형 AI 개념과 프롬프트 엔지니어링 기초",descEn:"Generative AI concepts and prompt engineering basics",topics:y},{id:"document",titleKo:"문서행정 자동화",titleEn:"Document Automation",descKo:"1일차 - 공문서, PPT, Excel 자동화",descEn:"Documents, PPT, Excel automation",topics:I},{id:"hr",titleKo:"인사행정 자동화",titleEn:"HR Automation",descKo:"인사·근태, 보고자료, 업무자동화",descEn:"HR, attendance, reports, workflow",topics:v}];function R(){const{language:c}=f(),a=c==="ko",{category:s}=p(),t=g(),i=m.find(n=>n.id===s)||m[0];return h.useEffect(()=>{if(t.hash){const n=t.hash.slice(1);setTimeout(()=>{var o;return(o=document.getElementById(n))==null?void 0:o.scrollIntoView({behavior:"smooth",block:"start"})},150)}else window.scrollTo({top:0})},[t.hash,s]),e.jsxs("div",{className:"learning-page",children:[e.jsx(A,{title:a?i.titleKo:i.titleEn}),e.jsxs("div",{className:"learning-layout",children:[e.jsx("aside",{className:"learning-sidebar",children:e.jsxs("div",{className:"sidebar-inner",children:[e.jsx("div",{className:"sidebar-header",children:a?i.titleKo:i.titleEn}),e.jsxs("div",{className:"sidebar-group",children:[e.jsx("div",{className:"sidebar-group-title",children:a?"학습 주제":"Topics"}),i.topics.map(n=>e.jsx("a",{href:`#${n.id}`,className:"sidebar-item",onClick:o=>{var l;o.preventDefault(),(l=document.getElementById(n.id))==null||l.scrollIntoView({behavior:"smooth",block:"start"})},children:a?n.titleKo:n.titleEn},n.id))]}),e.jsxs("div",{className:"sidebar-group",children:[e.jsx("div",{className:"sidebar-group-title",children:a?"바로가기":"Quick Links"}),e.jsx(d,{to:"/tools",className:"sidebar-item",children:a?"도구 가이드":"Tool Guide"}),e.jsx(d,{to:"/community",className:"sidebar-item",children:a?"커뮤니티":"Community"})]})]})}),e.jsxs("div",{className:"learning-content",children:[e.jsxs("div",{className:"learning-content-header",children:[e.jsx("h1",{children:a?i.titleKo:i.titleEn}),e.jsx("p",{children:a?i.descKo:i.descEn})]}),i.topics.map(n=>e.jsxs("section",{id:n.id,className:"topic-section",children:[e.jsx("div",{className:"topic-header",children:e.jsxs("div",{className:"topic-header-text",children:[e.jsx("h2",{children:a?n.titleKo:n.titleEn}),e.jsx("p",{children:a?n.descKo:n.descEn})]})}),e.jsx("div",{className:"topic-content",children:n.sections.map((o,l)=>e.jsxs("div",{className:"section-block",children:[e.jsx("h3",{className:"section-block-title",children:a?o.titleKo:o.titleEn}),e.jsx("div",{className:"section-block-body",children:P(a?o.contentKo:o.contentEn)})]},l))})]},n.id))]})]})]})}function P(c){const a=c.split(`
...
`)})},`code-${t}`));continue}if(i.startsWith("|")){const n=[];for(;t<a.length&&a[t].startsWith("|");)n.push(a[t]),t++;s.push(E(n,`tbl-${t}`));continue}if(i.startsWith("**")&&i.endsWith("**")){s.push(e.jsx("h4",{dangerouslySetInnerHTML:{__html:r(i)}},t)),t++;continue}if(i.startsWith(">")){s.push(e.jsx("blockquote",{dangerouslySetInnerHTML:{__html:r(i.slice(1).trim())}},t)),t++;continue}if(i.startsWith("- [")){s.push(e.jsx("div",{className:"checklist-item",dangerouslySetInnerHTML:{__html:r(i)}},t)),t++;continue}if(i.startsWith("- ")||i.startsWith("* ")){s.push(e.jsx("li",{dangerouslySetInnerHTML:{__html:r(i.slice(2))}},t)),t++;continue}if(/^\d+\.\s/.test(i)){s.push(e.jsx("li",{className:"ol-item",dangerouslySetInnerHTML:{__html:r(i.replace(/^\d+\.\s/,""))}},t)),t++;continue}if(!i.trim()){t++;continue}s.push(e.jsx("p",{dangerouslySetInnerHTML:{__html:r(i)}},t)),t++}return s}function E(c,a){const s=c.filter(n=>!n.trim().match(/^\|[-:\s|]+\|$/)).map(n=>n.split("|").filter(o=>o.trim()).map(o=>o.trim()));if(s.length===0)return null;const t=s[0],i=s.slice(1);return e.jsxs("table",{children:[e.jsx("thead",{children:e.jsx("tr",{children:t.map((n,o)=>e.jsx("th",{dangerouslySetInnerHTML:{__html:r(n)}},o))})}),e.jsx("tbody",{children:i.map((n,o)=>e.jsx("tr",{children:n.map((l,u)=>e.jsx("td",{dangerouslySetInnerHTML:{__html:r(l)}},u))},o))})]},a)}function r(c){return c.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/`(.+?)`/g,"<code>$1</code>").replace(/\[(.+?)\]\((.+?)\)/g,'<a href="$2" target="_blank" rel="noopener noreferrer">$1</a>').replace(/- \[ \]/g,'<span class="check-box">&#9744;</span>').replace(/- \[x\]/g,'<span class="check-box checked">&#9745;</span>')}export{R as default};
