import{j as e}from"./markdown-uD28ob7P.js";import{b as v,f as A,u as P,L as h}from"./vendor-j2q2Hh8J.js";import{u as b}from"./index-UJfKxgbT.js";import{S as K}from"./SEOHead-CXt37xNM.js";import"./supabase-ClMXFR6t.js";function d({code:l,isKo:a=!0}){const[i,r]=v.useState(!1),n=async()=>{try{await navigator.clipboard.writeText(l)}catch{const t=document.createElement("textarea");t.value=l,t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t)}r(!0),setTimeout(()=>r(!1),2e3)};return e.jsxs("div",{className:"prompt-block",children:[e.jsxs("div",{className:"prompt-block-header",children:[e.jsxs("span",{className:"prompt-block-label",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"}),a?"프롬프트":"Prompt"]}),e.jsxs("button",{type:"button",className:`prompt-copy-btn ${i?"copied":""}`,onClick:n,children:[e.jsx("i",{className:`fa-solid ${i?"fa-check":"fa-copy"}`}),i?a?"복사됨":"Copied":a?"복사":"Copy"]})]}),e.jsx("pre",{className:"prompt-block-body",children:e.jsx("code",{children:l})})]})}const f={"meeting-reports":[{level:"basic",titleKo:"회의록 요약",titleEn:"Meeting Minutes Summary",promptKo:`[역할] 대학 행정 담당자
...
- [ ] Have established a specific plan for applying AI to work`}]}],y=[{id:"basic",titleKo:"기본학습자료",titleEn:"Basic Materials",descKo:"생성형 AI 개념과 프롬프트 엔지니어링 기초",descEn:"Generative AI concepts and prompt engineering basics",topics:w},{id:"document",titleKo:"문서행정 자동화",titleEn:"Document Automation",descKo:"1일차 - 공문서, PPT, Excel 자동화",descEn:"Documents, PPT, Excel automation",topics:k},{id:"hr",titleKo:"인사행정 자동화",titleEn:"HR Automation",descKo:"인사·근태, 보고자료, 업무자동화",descEn:"HR, attendance, reports, workflow",topics:C}];function H(){const{language:l}=b(),a=l==="ko",{category:i}=A(),r=P(),n=y.find(t=>t.id===i)||y[0];return v.useEffect(()=>{if(r.hash){const t=r.hash.slice(1);setTimeout(()=>{var o;return(o=document.getElementById(t))==null?void 0:o.scrollIntoView({behavior:"smooth",block:"start"})},150)}else window.scrollTo({top:0})},[r.hash,i]),e.jsxs("div",{className:"learning-page",children:[e.jsx(K,{title:a?n.titleKo:n.titleEn}),e.jsxs("div",{className:"learning-layout",children:[e.jsx("aside",{className:"learning-sidebar",children:e.jsxs("div",{className:"sidebar-inner",children:[e.jsx("div",{className:"sidebar-header",children:a?n.titleKo:n.titleEn}),e.jsxs("div",{className:"sidebar-group",children:[e.jsx("div",{className:"sidebar-group-title",children:a?"학습 주제":"Topics"}),n.topics.map(t=>e.jsx("a",{href:`#${t.id}`,className:"sidebar-item",onClick:o=>{var s;o.preventDefault(),(s=document.getElementById(t.id))==null||s.scrollIntoView({behavior:"smooth",block:"start"})},children:a?t.titleKo:t.titleEn},t.id))]}),e.jsxs("div",{className:"sidebar-group",children:[e.jsx("div",{className:"sidebar-group-title",children:a?"바로가기":"Quick Links"}),e.jsx(h,{to:"/tools",className:"sidebar-item",children:a?"도구 가이드":"Tool Guide"}),e.jsx(h,{to:"/community",className:"sidebar-item",children:a?"커뮤니티":"Community"})]})]})}),e.jsxs("div",{className:"learning-content",children:[e.jsxs("div",{className:"learning-content-header",children:[e.jsx("h1",{children:a?n.titleKo:n.titleEn}),e.jsx("p",{children:a?n.descKo:n.descEn})]}),n.topics.map(t=>e.jsxs("section",{id:t.id,className:"topic-section",children:[e.jsx("div",{className:"topic-header",children:e.jsxs("div",{className:"topic-header-text",children:[e.jsx("h2",{children:a?t.titleKo:t.titleEn}),e.jsx("p",{children:a?t.descKo:t.descEn})]})}),e.jsxs("div",{className:"topic-content",children:[t.sections.map((o,s)=>e.jsxs("div",{className:"section-block",children:[e.jsx("h3",{className:"section-block-title",children:a?o.titleKo:o.titleEn}),e.jsx("div",{className:"section-block-body",children:R(a?o.contentKo:o.contentEn,a)})]},s)),f[t.id]&&e.jsxs("div",{className:"section-block",children:[e.jsxs("h3",{className:"section-block-title",children:[e.jsx("i",{className:"fa-solid fa-dumbbell",style:{marginRight:8,color:"var(--primary-blue)"}}),a?"실습 문제 (난이도별)":"Practice (by Level)"]}),e.jsxs("div",{className:"section-block-body",children:[e.jsx("p",{className:"practice-bank-intro",children:a?"진도에 맞춰 골라 연습하세요. 각 프롬프트는 복사 버튼으로 복사해 ChatGPT·Claude 등에 붙여넣고 실습할 수 있습니다.":"Pick by your pace. Copy each prompt and paste it into ChatGPT/Claude to practice."}),["basic","applied","advanced"].map(o=>{const s=f[t.id].filter(p=>p.level===o);return s.length===0?null:e.jsxs("div",{className:"practice-bank-level",children:[e.jsx("h4",{className:`practice-bank-level-title ${u[o].badge}`,children:a?u[o].ko:u[o].en}),s.map((p,E)=>e.jsxs("div",{className:"practice-bank-item",children:[e.jsx("div",{className:"practice-bank-item-title",children:a?p.titleKo:p.titleEn}),e.jsx(d,{code:a?p.promptKo:p.promptEn,isKo:a})]},E))]},o)})]})]}),g[t.id]&&e.jsxs("div",{className:"section-block",children:[e.jsxs("h3",{className:"section-block-title",children:[e.jsx("i",{className:"fa-solid fa-circle-play",style:{marginRight:8,color:"var(--primary-blue)"}}),a?"완성형 실전 예시 (바로 실행)":"Worked Examples (ready to run)"]}),e.jsxs("div",{className:"section-block-body",children:[e.jsx("p",{className:"practice-bank-intro",children:a?"빈칸 없이 그대로 복사해 실행하면 결과가 나오는 완성 프롬프트입니다. 강의 중 시연하거나, 결과를 보고 나만의 상황으로 바꿔 보세요.":"Complete prompts you can copy and run as-is. Demo them in class, then adapt to your own situation."}),g[t.id].map((o,s)=>e.jsxs("div",{className:"worked-example",children:[e.jsx("div",{className:"worked-example-title",children:a?o.titleKo:o.titleEn}),e.jsx(d,{code:a?o.promptKo:o.promptEn,isKo:a}),e.jsxs("div",{className:"worked-example-output",children:[e.jsx("i",{className:"fa-solid fa-arrow-turn-down"}),e.jsx("span",{children:a?o.outputKo:o.outputEn})]})]},s))]})]}),m[t.id]&&e.jsxs("div",{className:"section-block",children:[e.jsxs("h3",{className:"section-block-title",children:[e.jsx("i",{className:"fa-solid fa-list-check",style:{marginRight:8,color:"var(--primary-blue)"}}),a?"단계별 실습 워크시트":"Step-by-Step Worksheet"]}),e.jsxs("div",{className:"section-block-body",children:[e.jsxs("div",{className:"worksheet-goal",children:[e.jsx("strong",{children:a?m[t.id].titleKo:m[t.id].titleEn}),e.jsx("p",{children:a?m[t.id].goalKo:m[t.id].goalEn})]}),m[t.id].steps.map((o,s)=>e.jsxs("div",{className:"worksheet-step",children:[e.jsx("div",{className:"worksheet-step-title",children:a?o.stepKo:o.stepEn}),e.jsx(d,{code:a?o.promptKo:o.promptEn,isKo:a}),e.jsxs("div",{className:"worksheet-step-check",children:[e.jsx("i",{className:"fa-solid fa-square-check"}),e.jsx("span",{children:a?o.checkKo:o.checkEn})]})]},s))]})]})]})]},t.id))]})]})]})}function R(l,a=!0){const i=l.split(`
`),r=[];let n=0;for(;n<i.length;){const t=i[n];if(t.startsWith("```")){const o=[];for(n++;n<i.length&&!i[n].startsWith("```");)o.push(i[n]),n++;n++,r.push(e.jsx(d,{code:o.join(`
`),isKo:a},`code-${n}`));continue}if(t.startsWith("|")){const o=[];for(;n<i.length&&i[n].startsWith("|");)o.push(i[n]),n++;r.push(x(o,`tbl-${n}`));continue}if(t.startsWith("**")&&t.endsWith("**")){r.push(e.jsx("h4",{dangerouslySetInnerHTML:{__html:c(t)}},n)),n++;continue}if(t.startsWith(">")){r.push(e.jsx("blockquote",{dangerouslySetInnerHTML:{__html:c(t.slice(1).trim())}},n)),n++;continue}if(t.startsWith("- [")){r.push(e.jsx("div",{className:"checklist-item",dangerouslySetInnerHTML:{__html:c(t)}},n)),n++;continue}if(t.startsWith("- ")||t.startsWith("* ")){r.push(e.jsx("li",{dangerouslySetInnerHTML:{__html:c(t.slice(2))}},n)),n++;continue}if(/^\d+\.\s/.test(t)){r.push(e.jsx("li",{className:"ol-item",dangerouslySetInnerHTML:{__html:c(t.replace(/^\d+\.\s/,""))}},n)),n++;continue}if(!t.trim()){n++;continue}r.push(e.jsx("p",{dangerouslySetInnerHTML:{__html:c(t)}},n)),n++}return r}function x(l,a){const i=l.filter(t=>!t.trim().match(/^\|[-:\s|]+\|$/)).map(t=>t.split("|").filter(o=>o.trim()).map(o=>o.trim()));if(i.length===0)return null;const r=i[0],n=i.slice(1);return e.jsxs("table",{children:[e.jsx("thead",{children:e.jsx("tr",{children:r.map((t,o)=>e.jsx("th",{dangerouslySetInnerHTML:{__html:c(t)}},o))})}),e.jsx("tbody",{children:n.map((t,o)=>e.jsx("tr",{children:t.map((s,p)=>e.jsx("td",{dangerouslySetInnerHTML:{__html:c(s)}},p))},o))})]},a)}function c(l){return l.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/`(.+?)`/g,"<code>$1</code>").replace(/\[(.+?)\]\((.+?)\)/g,'<a href="$2" target="_blank" rel="noopener noreferrer">$1</a>').replace(/- \[ \]/g,'<span class="check-box">&#9744;</span>').replace(/- \[x\]/g,'<span class="check-box checked">&#9745;</span>')}export{H as default};
